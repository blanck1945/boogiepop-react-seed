    ...
    <div style={{
      ...
      {detail && (
        <>
          ...
          {/* Footer — GitHub link */}
          <div style={{ padding: '14px 20px', borderTop: `1px solid ${colors.border}20` }}>
            <a
              href={detail.github}
              target="_blank"
              ...
              style={{
                ...
                borderRadius: 6,
                transition: 'all 0.15s',
                background: colors.badge + '08',
              }}
              onMouseEnter={e => {
                e.currentTarget.style.borderColor = colors.border + '70'
                e.currentTarget.style.background = colors.badge + '14'
              }}
              onMouseLeave={e => {
                e.currentTarget.style.borderColor = colors.border + '30'
                e.currentTarget.style.background = colors.badge + '08'
              }}
            >
              ...
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginLeft: 'auto', opacity: 0.6 }}>
